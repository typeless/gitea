...
func (c *Commit) SearchCommits(keywords, authors, committers, files []string, after, before string, all bool) (*list.List, error) {
	return c.repo.searchCommits(c.ID, keywords, authors, committers, files, after, before, all)
}
